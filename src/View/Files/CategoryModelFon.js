...
var list=[
    ...
    {cat:2,image:"./img/2/2.jpg",name:'1CXT',f_col:'Глубина копания',s_col:'Масса',t_col:'Объём ковша', first:'3080 мм',second:'4342 кг',third:'0.36 м3',text:'Экскаваторы-погрузчики'},
    {cat:2,image:"./img/2/1.jpg",name:'1CХ',f_col:'Глубина копания',s_col:'Масса',t_col:'Объём ковша', first:'3080 мм',second:'3228 кг',third:'0.31 м3',text:'Экскаваторы-погрузчики'},
...
export class CategoryModelFon extends Component {
    state={
        file_list:[],
        modal_show:false,
        file:"",
    ...
    refresh=()=>{
        Axios.get(url+'category_models_fon').then(res=>{this.setState({file_list:res.data});});
    }
    componentWillMount(){
        this.refresh();
    }
    ...
    handleSubmit=()=>{
        ...
        Axios.post(url+"category_models_fon",data).then(res=>{
            console.log(res);
            this.refresh();
                ...
                render: (text, record) => (
                  <span>
                    <Popconfirm
                            ...
                            onConfirm={()=>{Axios.post(url+"category_models_fon/delete"+record.file_id,{info:record}).then(res=>{this.refresh()})}}
                            okText="Да"
                            cancelText="Нет"
                        >
                            <a>Удалить</a>
...
export default CategoryModelFon;
