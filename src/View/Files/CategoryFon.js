...
export class CategoryFon extends Component {
    state={
        file_list:[],
        modal_show:false,
        file:"",
    ...
    refresh=()=>{
        Axios.get(url+'category_fon').then(res=>{this.setState({file_list:res.data});});
    }
    componentWillMount(){
        this.refresh();
    }
    ...
    handleSubmit=()=>{
        ...
        Axios.post(url+"category_fon",data).then(res=>{
            console.log(res);
            this.refresh();
                ...
                render: (text, record) => (
                  <span>
                    <Popconfirm
                            ...
                            onConfirm={()=>{Axios.post(url+"category_fon/delete"+record.file_id,{info:record}).then(res=>{this.refresh()})}}
                            okText="Да"
                            cancelText="Нет"
                        >
                            <a>Удалить</a>
