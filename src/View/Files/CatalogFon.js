...
export class CatalogFon extends Component {
    state={
        file_list:[],
        modal_show:false,
        file:"",
    ...
    refresh=()=>{
        Axios.get(url+'catalog_background').then(res=>{this.setState({file_list:res.data});});
    ...
    handleSubmit=()=>{
        ...
        Axios.post(url+"catalog_background",data).then(res=>{
            console.log(res);
            this.refresh();
        ...
        return (
            ...
            <div style={{maxWidth:"90%",width:"90%",marginLeft:"80px",marginTop:"40px"}}>
                ...
                <Button.Group style={{marginBottom:"20px"}}>
                    ...
                    <Button onClick={this.showDrawer} type="primary" >Изменить</Button>
                </Button.Group>
